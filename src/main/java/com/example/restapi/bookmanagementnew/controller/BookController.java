...
private final BookService bookService;
    ...
    public ResponseEntity<List<BookDto>> getBooksPublishedBeforeDate(@RequestParam @DateTimeFormat(pattern = "yyyy-mm-dd") LocalDate date)
    {
        List<BookDto> books=bookService.getBooksPublishedBeforeDate(date);
        return ResponseEntity.ok(books);
    }
    @PostMapping
